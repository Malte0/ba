...
def player_thinking_steps(player_index):
    return min(100, 0+player_index*N)
VERBOSE = False
...
def main():
    ...
    for options in range(2, K+1):
        for _ in range(NUMBER_OF_ITERATIONS):
            ...
            results, games_played, thinking_times, computation_steps = play_tournament(players, N, K, NUMBER_OF_GAMES, create_T=MODIFIED_T, verbose=VERBOSE)
